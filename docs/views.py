...
def build_payload(mode: str, prompt: str, html: str, selection: str, *, stream: bool = False):
    ...
    """
    system_msg = (
    "Ты пишешь строгие технические задания (ТЗ).\n"
    "- Не указывай ответственных лиц, бюджеты, компании, даты, фамилии.\n"
    "- Не используй вымышленные данные и placeholders.\n"
    "- Пиши сухо и по делу: требования, сценарии, интерфейсы, данные, API, критерии приёмки.\n"
    "- Если чего-то не хватает, предлагай нейтральные варианты или помечай как TBD.\n"
    "- Формат: разделы, нумерованные пункты, чек-листы критериев приёмки.\n"
)
